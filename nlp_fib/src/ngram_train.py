...
class NgramTrain:
    def __init__(self, preprocessed_dataframe, input_file_path):
        ...
        data.write_pickle_file(self.bigram_count, input_file_path, 'bigram_count.pickle', True)
        ...
        data.write_pickle_file(self.bigram_forward_probability, input_file_path, 'bigram_forward_prob.pickle', True)
        ...
        data.write_pickle_file(self.bigram_backward_probability, input_file_path, 'bigram_backward_prob.pickle', True)
